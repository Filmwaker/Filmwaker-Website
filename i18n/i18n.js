  ...
  const _dict = {
    ...
    it: {
      ...
      portfolio: {
        ...
        p1_tag:"VFX & Virtual Production", p1_h2:"Death Stranding 2 — Higgs Fan Film",
        p1_h3a:"Il Progetto", p1_p1:"Un fan film dedicato al personaggio di Higgs da Death Stranding 2, interpretato da Jessica Armanetti. L'obiettivo era portare in vita un personaggio iconico del videogioco in un ambiente sci-fi credibile, in soli 10 giorni di produzione.",
        p1_h3b:"Cosa Abbiamo Fatto", p1_p2:"Abbiamo ripreso Jessica su green screen applicando un sistema di camera tracking dal vivo, poi integrato in Unreal Engine 5. Per il relight del personaggio abbiamo usato Beeble, tool AI che ricrea l'illuminazione dell'ambiente virtuale direttamente sull'attore in tempo reale. Il camera tracking fisico e il movimento di scena sono stati poi sincronizzati nella comp finale, ottenendo un risultato di grande impatto considerando i tempi di produzione.",
    ...
    en: {
      ...
      portfolio: {
        ...
        p1_tag:"VFX & Virtual Production", p1_h2:"Death Stranding 2 — Higgs Fan Film",
        p1_h3a:"The Project", p1_p1:"A fan film dedicated to the character of Higgs from Death Stranding 2, played by Jessica Armanetti. The goal was to bring an iconic video game character to life in a credible sci-fi environment — in just 10 days of production.",
        p1_h3b:"What We Did", p1_p2:"We filmed Jessica on green screen with a live camera tracking system, then integrated everything into Unreal Engine 5. For the character's relighting we used Beeble, an AI tool that recreates the virtual environment's lighting directly on the actor in real time. The physical camera tracking and on-set movements were then synced in the final comp, delivering a striking result given the production timeline.",
        p2_tag:"Commercial & Storytelling", p2_h2:"Corporate Brand Story",
