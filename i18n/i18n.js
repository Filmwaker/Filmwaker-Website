  ...
  const _dict = {
    ...
    it: {
      ...
      portfolio: {
        ...
        p1_h3a:"Il Progetto",
        p1_p1:"Un fan film dedicato all'universo di Death Stranding 2: On The Beach, con Jessica Armanetti nel ruolo di Higgs e Fabio Meschini nel ruolo di Sam. L'obiettivo era restituire l'atmosfera iconica del videogioco con un livello di realismo visivo da produzione professionale, rispettando l'estetica originale di Hideo Kojima — il tutto in soli 10 giorni di produzione totale. Il video ha raggiunto Hideo Kojima in persona, che lo ha visto e ricondiviso, riconoscendo la qualità del lavoro.",
        p1_h3b:"Cosa Abbiamo Fatto",
        p1_p2:"Le riprese sono state realizzate su green screen, con Jessica Armanetti e Fabio Meschini che hanno dato vita ai personaggi in un set minimalista. Parallelamente abbiamo costruito l'ambiente sci-fi interamente in Unreal Engine 5, con un livello di dettaglio che potesse reggere il confronto con la direzione artistica del gioco originale. Il cuore della produzione è stato il sistema di camera tracking: i movimenti fisici della camera sul set sono stati catturati in tempo reale e replicati fedelmente all'interno della scena virtuale in Unreal, creando una perfetta coerenza prospettica tra attori e ambiente digitale. Per garantire un'integrazione luminosa convincente tra i performer e l'ambiente virtuale, abbiamo integrato nel workflow una soluzione di relight AI che adattava dinamicamente l'illuminazione sull'attore in funzione della scena. La fase di compositing ha poi unito tutti gli elementi — attori, ambiente 3D, effetti e color grading — in un risultato finale che ha sorpreso per qualità e coerenza, considerando la brevità del periodo di produzione.",
    ...
    en: {
      ...
      portfolio: {
        ...
        p1_tag:"VFX & Virtual Production", p1_h2:"Death Stranding 2: On The Beach — Fan Film",
        p1_h3a:"The Project",
        p1_p1:"A fan film set in the universe of Death Stranding 2: On The Beach, featuring Jessica Armanetti as Higgs and Fabio Meschini as Sam. The goal was to capture the iconic atmosphere of the video game at a professional production level, honouring Hideo Kojima's original aesthetic — all within a total production window of just 10 days. The film reached Hideo Kojima himself, who watched it and reshared it, acknowledging the quality of the work.",
        p1_h3b:"What We Did",
        p1_p2:"The shoot took place on green screen, with Jessica Armanetti and Fabio Meschini bringing the characters to life on a minimal set. In parallel, we built the sci-fi environment entirely in Unreal Engine 5, with a level of detail designed to hold up against the original game's art direction. The heart of the production was the camera tracking system: the physical camera movements on set were captured in real time and faithfully replicated inside the virtual scene in Unreal, creating a perfect perspectival match between the performers and the digital environment. To ensure a convincing light integration between actors and the virtual world, we integrated an AI relighting solution into the workflow that dynamically adapted the on-actor lighting to match the virtual scene. The compositing phase then brought everything together — performers, 3D environment, effects and colour grading — into a final result that surprised for its quality and coherence, especially given how short the production window was.",
        p2_tag:"Commercial & Storytelling", p2_h2:"Corporate Brand Story",
