  ...
  const _dict = {
    ...
    it: {
      ...
      portfolio: {
        ...
        p5_tag:"CGI & Unreal Engine 5", p5_h2:"Metal Gear Solid 4: Guns of the Patriots \u2014 Unreal Engine 5",
        p5_h3a:"Il Progetto",
        p5_p1:"Un tributo a uno dei capitoli pi\u00f9 amati della saga di <strong>Hideo Kojima</strong>: una delle sequenze pi\u00f9 iconiche di <strong>Metal Gear Solid 4: Guns of the Patriots</strong> ricreata interamente in <strong>Unreal Engine 5</strong> con illuminazione in tempo reale, materiali aggiornati e animazioni personalizzate. L'obiettivo era restare fedeli al tono originale \u2014 non un redesign, ma una ricreazione rispettosa potenziata dagli strumenti della gen attuale. Il montaggio \u00e8 sincronizzato con <strong>Free Bird di Lynyrd Skynyrd</strong>, costruendo progressivamente verso il solo per amplificare la tensione e il peso emotivo della scena.",
        p5_h3b:"Cosa Abbiamo Fatto",
        p5_p2:"Abbiamo preso uno dei momenti cinematografici pi\u00f9 densi della serie e lo abbiamo reinterpretato con <strong>rendering in tempo reale</strong>, lighting cinematografico e materiali ad alta fedelt\u00e0, mantenendo intatta la pacing e l'atmosfera malinconica che Kojima ha costruito nell'originale. Ogni inquadratura \u00e8 stata ricreata con cura, rispettando composizione e ritmo della scena. Il risultato onora la visione del gioco originale pur sfruttando a pieno le capacit\u00e0 di <strong>Unreal Engine 5</strong>."
      },
      mission: {
    ...
    en: {
      ...
      portfolio: {
        ...
        p5_tag:"CGI & Unreal Engine 5", p5_h2:"Metal Gear Solid 4: Guns of the Patriots \u2014 Unreal Engine 5",
        p5_h3a:"The Project",
        p5_p1:"A tribute to one of the most beloved entries in <strong>Hideo Kojima</strong>'s saga: one of the most iconic sequences from <strong>Metal Gear Solid 4: Guns of the Patriots</strong>, recreated entirely in <strong>Unreal Engine 5</strong> with real-time lighting, updated materials and custom animation. The goal was to stay faithful to the original tone \u2014 not a redesign, but a respectful recreation powered by current-gen tools. The edit is fully synchronised with <strong>Free Bird by Lynyrd Skynyrd</strong>, building toward the solo to amplify the tension and emotional weight of the scene.",
        p5_h3b:"What We Did",
        p5_p2:"We took one of the most cinematically rich moments in the series and reinterpreted it with <strong>real-time rendering</strong>, cinematic lighting and high-fidelity materials, while preserving the pacing and melancholic atmosphere Kojima built into the original. Every shot was carefully recreated, respecting the composition and rhythm of the scene. The result honours the vision of the original game while fully leveraging the capabilities of <strong>Unreal Engine 5</strong>."
      },
      mission: {
        title:"Our Mission",
