  ...
  const _dict = {
    ...
    it: {
      ...
      portfolio: {
        ...
        p5_h3a:"Il Progetto",
        p5_p1:"Un tributo a <strong>Metal Gear Solid 4: Guns of the Patriots</strong> di <strong>Hideo Kojima</strong>: partendo da un momento di gameplay dell'ultimo capitolo della saga, abbiamo costruito una <strong>cutscene originale</strong> con un concept inedito, non il remake di una cinematica esistente. Il montaggio \u00e8 sincronizzato su <strong>Free Bird di Lynyrd Skynyrd</strong>, costruendo progressivamente verso il solo per amplificare tensione e peso emotivo della scena.",
        p5_h3b:"Cosa Abbiamo Fatto",
        p5_p2:"La produzione ha combinato una <strong>tuta da mocap</strong> per catturare le performance in modo naturale e fluido, con un pipeline di rendering ibrido che alterna <strong>Lumen</strong> per le scene in tempo reale e <strong>Path Tracing</strong> per i passaggi che richiedevano la massima qualit\u00e0 luminosa. Per il massimo realismo cinematografico abbiamo usato una <strong>VCAM</strong> \u2014 camera virtuale controllata fisicamente sul set \u2014 che ha permesso movimenti di macchina organici e credibili, impossibili da ottenere con animazioni manuali."
      },
      mission: {
    ...
    en: {
      ...
      portfolio: {
        ...
        p5_tag:"CGI & Unreal Engine 5", p5_h2:"Metal Gear Solid 4: Guns of the Patriots \u2014 Unreal Engine 5",
        p5_h3a:"The Project",
        p5_p1:"A tribute to <strong>Metal Gear Solid 4: Guns of the Patriots</strong> by <strong>Hideo Kojima</strong>: starting from a gameplay moment in the final chapter of the saga, we built an <strong>original cutscene</strong> with a new concept \u2014 not a remake of an existing cinematic. The edit is synchronised with <strong>Free Bird by Lynyrd Skynyrd</strong>, building toward the solo to amplify the tension and emotional weight of the scene.",
        p5_h3b:"What We Did",
        p5_p2:"The production combined a <strong>mocap suit</strong> to capture performances naturally and fluidly, with a hybrid rendering pipeline alternating between <strong>Lumen</strong> for real-time scenes and <strong>Path Tracing</strong> for sequences requiring maximum lighting quality. For cinematic realism we used a <strong>VCAM</strong> \u2014 a virtual camera physically operated on set \u2014 enabling organic, believable camera movements that would be impossible to achieve through manual animation."
      },
      mission: {
        title:"Our Mission",
