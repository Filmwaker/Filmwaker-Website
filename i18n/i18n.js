  ...
  const _dict = {
    ...
    it: {
      ...
      portfolio: {
        ...
        p2_h3a:"Il Progetto",
        p2_p1:"Una ricostruzione fedele e shot-per-shot della <strong>sequenza d'apertura di Metal Gear Solid 2: Sons of Liberty</strong> di <strong>Hideo Kojima</strong>, realizzata interamente in <strong>Unreal Engine 5</strong>. L'obiettivo era dimostrare fino a dove pu\u00f2 arrivare la produzione in real-time quando applicata con rigore artistico e tecnico a un materiale iconico.",
        p2_h3b:"Cosa Abbiamo Fatto",
        p2_p2:"Il personaggio di <strong>Snake</strong> \u00e8 stato costruito da zero come un <strong>Metahuman personalizzato</strong>, modellato e rifinito per rispecchiare fedelmente il design originale. Ogni inquadratura \u00e8 stata analizzata e ricreata manualmente, rispettando composizione, timing e atmosfera. L'ambiente — il ponte della <strong>USS Discovery</strong> sotto la pioggia — \u00e8 stato costruito pezzo per pezzo con particolare attenzione all'illuminazione drammatica, alle particelle atmosferiche e alla qualit\u00e0 dei materiali.",
    ...
    en: {
      ...
      portfolio: {
        ...
        p2_h3b:"What We Did",
        p2_p2:"The character of <strong>Snake</strong> was built from scratch as a fully custom <strong>Metahuman</strong>, modelled and refined to faithfully match the original character design. Every shot was analysed and recreated by hand, respecting the composition, timing and atmosphere of the original sequence. The environment — the deck of the <strong>USS Discovery</strong> in the rain — was constructed piece by piece, with particular attention to dramatic lighting, atmospheric particle simulation and material quality.",
